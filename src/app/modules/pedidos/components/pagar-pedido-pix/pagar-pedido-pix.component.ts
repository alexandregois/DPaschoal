...
@Component({
  selector: 'app-pagar-pedido-pix',
  templateUrl: './pagar-pedido-pix.component.html',
  styleUrls: ['./pagar-pedido-pix.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PagarPedidoPixComponent implements OnInit {
